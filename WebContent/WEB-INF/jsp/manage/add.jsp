...
<head>
 ...
 <body>
    <div class="x-body">
        <form class="layui-form" method="post" action="${ctx}/manage_exAdd.do" enctype="multipart/form-data">
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="realName" required="" lay-verify="required"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
