...
<head>
 ...
 <body>
    <div class="x-body">
        <form class="layui-form" method="post" action="${ctx}/goods_exUpdate.do" enctype="multipart/form-data">
         <input type="hidden" name="id" value="${Obj.id }">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="price" value="${Obj.price }" required="" lay-verify="required"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
               ...
               <div class="layui-input-inline">
                  <select class="select" name="pp.id" class="valid">
