...
<!-- private String name;
	...
	private int type;//1.经理 2店长 3 员工
	
	private String phone;
	private String code; -->
    <div class="x-body">
        <form class="layui-form" method="post" action="${ctx}/manage_exUpdate.do" enctype="multipart/form-data">
         <input type="hidden" name="id" value="${Obj.id}">
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="realName" required="" value="${Obj.realName}" lay-verify="required"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
