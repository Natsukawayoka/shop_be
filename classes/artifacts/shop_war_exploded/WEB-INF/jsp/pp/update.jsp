...
<head>
 ...
 <body>
    <div class="x-body">
        <form class="layui-form" method="post" action="${ctx}/pp_exUpdate.do" enctype="multipart/form-data">
	  ...
	  <input type="hidden" name="lbId" value="${lbId}">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="name"  value="${Obj.name }" required="" lay-verify="required"
